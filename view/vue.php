            ...
            <ul class="timeline">
                    ...
                    <div class="timeline-panel-container">
                        <div class="timeline-panel"> 
                            <div class="timeline-heading" >
                                ...
                                <h1> Développement html , css , php   </h1>
                                <p class="text-muted"> <small class="glyphicon glyphicon-time"> 2019 - 2021</small> </p>
                            </div>
                            <div class="timeline-body">
                                <p> Presentation du site , création du formulaire de contact , rédaction des mentions légales </p>
                            </div>
                        </div>
                    </div>
                ...
                <li>
                    ...
                    <div class="timeline-panel-container-inverted">
                        <div class="timeline-panel"> 
                            <div class="timeline-heading" >
                                <h3> Développement du jeu de la Vie  </h3>
                                <h1> Developpement html css , javascript   </h1>
                                <p class="text-muted"> <small class="glyphicon glyphicon-time"> 2019 - 2021</small> </p>
                            </div>
                            <div class="timeline-body">
                                <p> Création de la grille , gestion des événements (bouton d'arrêt , bouton 
                                    pas à pas , boutons pour lancer des configurations prédéfinies 
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="timeline-panel-container">
                        <div class="timeline-panel"> 
                            <div class="timeline-heading" >
                                ...
                                <h1> Développement en Java  </h1>
                                <p class="text-muted"> <small class="glyphicon glyphicon-time"> 2019 - 2021</small> </p>
                            </div>
                            <div class="timeline-body">

                                <p> Scrum Master / Chef de Projet. Développement d'une intelligence artificielle permettant 
                                    de gérer les itinéraires d'un réseau de bus. (Développement d'algorithme liés à la théorie
                                    des graphes). 
                                </p>
            ...
            <div class="row">
                <div class="col-sm-6">
                    <div class="education-block">
                        ...
                        <br><br>
                        <p> Option math expertes et SES (sciences économiques et sociales )  </p>
                    </div>
                </div>
                <div class="col-sm-6">
                    <div class="education-block">
                        ...
                        <H4> 2 Semestres validés   </H4>
                        <div  class="red-divider">  </div>
                        <br><br>
                        <p> Premiere année d IUT INFORMATIQUE </p>
